...
indexRouter.put("/blogPosts/edit/", indexController.verifyToken, indexController.editSelectedBlogPost);
indexRouter.put("/blogPosts/publishToggle/", indexController.verifyToken, indexController.togglePublishSelectedBlogPost);
indexRouter.post("/blogPosts/create", indexController.verifyToken, indexController.createNewBlogPost);
indexRouter.delete("/blogPosts/delete/", indexController.verifyToken, indexController.deleteSelectedBlogPost);
